        ...
        # Apply a crop
            ...
            if self.image is not None:
                ...
                for ic in self.intrinsics_constraints:
                    ...
                    # Note - here we store the new intrinsics images in original coords, so they still need to be converted to display coords but can't yet because we haven't updated the CoordsTransformer yet.
                    # So the conversion back to display coords happens about 40 lines later...
