# -*- coding: utf-8 -*-
#
# Calcam documentation build configuration file, created by
# sphinx-quickstart on Thu Feb 15 20:05:57 2018.
#
...
project = u'Calcam'
copyright = u'2015-2023, European Atomic Energy Community (EURATOM)'
...
latex_documents = [
    (master_doc, 'Calcam.tex', u'Calcam Documentation',
     u'Scott Silburn, James Harrison et. al.', 'manual'),
]
...
man_pages = [
    (master_doc, 'calcam', u'Calcam Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Calcam', u'Calcam Documentation',
     author, 'Calcam', 'One line description of project.',
     'Miscellaneous'),
]
